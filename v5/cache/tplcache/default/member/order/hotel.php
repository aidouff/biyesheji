...
<head>
    <meta charset="utf-8">
    <title> <?php if($ordertype=='all') { ?>全部酒店订单<?php } else if($ordertype=='unpay') { ?>未付款酒店订单<?php } else { ?>未点评酒店订单<?php } ?>
                        ...
                        <div class="order-list">
                            <table width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <td align="center"><span class="attr"><?php echo $row['departdate'];?></span></td>
