...
<head>
<meta charset="utf-8">
<title>会员注册-<?php echo $webname;?></title>
    <?php echo  Stourweb_View::template("pub/varname");  ?>
    <?php echo Common::css('user.css,base.css,extend.css');?>
    <?php echo Common::js('jquery.min.js,base.js,common.js,jquery.validate.js,jquery.cookie.js');?>
</head>
<body>
  ...
  <div class="st-userlogin-box">
    ...
    <div class="st-reg-box">
      ...
      <div class="reg-cont-box">
           <form id="phonefrm" method="post" action="<?php echo $cmsurl;?>member/register/doreg">
        <ul id="phone_reg">
          <li>
              ...
              <span class="msg_contain"></span>
                ...
                <li>
                  ...
                  <span class="reg-yzm"><img src="<?php echo $cmsurl;?>captcha" width="114" height="31" onClick="this.src=this.src+'?math='+ Math.random()" /></span>
                  <span class="reg-change"><a href="javascript:;">换一张</a></span>
                  <span class="msg_contain"></span>
                </li>
            <?php if($msgcode == 'shortmsg') { ?>
                <li>
          ...
          <li>
            ...
            <!--邮箱登陆-->
           <form id="emailfrm" method="post" action="<?php echo $cmsurl;?>member/register/doreg">
            ...
            <span class="bt-sp">登录帐号</span>
              <input type="text" class="reg-text w230" id="email" name="email" placeholder="请输入邮箱帐号" />
                ...
                <li>
                    ...
                    <span class="reg-yzm"><img src="<?php echo $cmsurl;?>captcha" onClick="this.src=this.src+'?math='+ Math.random()" width="114" height="31" /></span>
                    <span class="reg-change"><a href="javascript:;">换一张</a></span>
                    <span class="msg_contain"></span>
                </li>
                <?php if($emailcode == 1) { ?>
        ...
        <div class="reg-tig-box">
          ...
          <dl>
            ...
            <dd>
                ...
                <a class="qq qqlogin" href="<?php echo $GLOBALS['cfg_basehost'];?>/member/login/qq">QQ</a>
                <?php } ?>
                <?php if((!empty($GLOBALS['cfg_weixi_appkey']) && !empty($GLOBALS['cfg_weixi_appsecret']))) { ?>
                <a class="wx wxlogin" href="<?php echo $GLOBALS['cfg_basehost'];?>/member/login/weixin">wx</a>
                <?php } ?>
                <?php if((!empty($GLOBALS['cfg_sina_appkey']) && !empty($GLOBALS['cfg_sina_appsecret']))) { ?>
                <a class="wb wblogin" href="<?php echo $GLOBALS['cfg_basehost'];?>/member/login/sina">wb</a>
                <?php } ?>
            </dd>
          </dl>
        </div>
 ...
 <input type="hidden" id="backurl" value="<?php echo $backurl;?>"/>
