    ...
    <ul>
        ...
        <li>
            ...
            <div class="son">
                ...
                <?php $n=1; if(is_array(Model_Model::tongyoug_model())) { foreach(Model_Model::tongyoug_model() as $row) { ?>
                    <a id="nav_<?php echo $row['pinyin'];?>order" href="/member/order/tongyong?typeid=<?php echo $row['id'];?>"><?php echo $row['modulename'];?>订单</a>
                <?php $n++;}unset($n); } ?>
            </div>
        </li>
