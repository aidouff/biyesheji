...
<div class="st-footer">
    <div class="wm-1200">
        <div class="st-foot-menu">
           <?php require_once ("C:/phpstudy/WWW/taglib/footnav.php");$footnav_tag = new Taglib_Footnav();if (method_exists($footnav_tag, 'pc')) {$data = $footnav_tag->pc(array('action'=>'pc','row'=>'10',));}?>
